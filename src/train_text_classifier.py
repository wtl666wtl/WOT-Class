...
from utils import load_classnames, load_labels, load_text, load_labels_num
...
class DProcessor(DataProcessor):
    def __init__(self, task, train_suffix, test_suffix):
        ...
        self.labels = list(range(load_labels_num(os.path.join(DATA_FOLDER_PATH, self.train_dir))))
